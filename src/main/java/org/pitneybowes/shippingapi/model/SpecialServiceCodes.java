 ...
 */
@JsonAdapter(SpecialServiceCodes.Adapter.class)
public enum SpecialServiceCodes {
  ...
  SpecialServiceCodes(String value) {
    this.value = value;
  }
  ...
  public static SpecialServiceCodes fromValue(String value) {
    for (SpecialServiceCodes b : SpecialServiceCodes.values()) {
  ...
  public static class Adapter extends TypeAdapter<SpecialServiceCodes> {
    @Override
    public void write(final JsonWriter jsonWriter, final SpecialServiceCodes enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SpecialServiceCodes read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SpecialServiceCodes.fromValue(value);
    }
  }
}
